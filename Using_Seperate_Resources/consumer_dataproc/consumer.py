...
KAFKA_BOOTSTRAP_SERVERS = "34.30.61.53:9092"
...
# Extended options for Kafka connection
kafka_options = {
    "kafka.bootstrap.servers": KAFKA_BOOTSTRAP_SERVERS,
    "subscribe": KAFKA_TOPIC,
    "startingOffsets": "latest",
    "kafka.request.timeout.ms": "120000",           # 2 minutes timeout for requests
    "kafka.session.timeout.ms": "120000",           # 2 minutes for session timeout
    "kafka.connection.timeout.ms": "120000",        # 2 minutes for connection
    "kafka.max.poll.interval.ms": "300000",         # 5 minutes for max poll interval
    "kafka.metadata.max.age.ms": "180000",          # 3 minutes for metadata refresh
    "failOnDataLoss": "false",                     # Don't fail if data is lost
    "maxOffsetsPerTrigger": "1000"                 # Limit the number of records per trigger
}
